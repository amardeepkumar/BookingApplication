...
import com.helthifyme.bookingapplication.widget.ExpandableItemIndicator;
...
public class ExpandableExampleAdapter
    ...
    public static abstract class MyBaseViewHolder extends AbstractExpandableItemViewHolder {
        ...
        public MyBaseViewHolder(View v) {
            ...
            mCountTextView = (TextView) v.findViewById(android.R.id.text2);
        }
    }
    ...
    public void onBindGroupViewHolder(MyGroupViewHolder holder, int groupPosition, int viewType) {
        ...
        holder.mCountTextView.setText(mProvider.getGroupItem(groupPosition).getChildCount());
    ...
    public void onBindChildViewHolder(MyChildViewHolder holder, int groupPosition, int childPosition, int viewType) {
        ...
        holder.mContainer.setBackgroundResource(item.getIsAvailable() ? R.drawable.bg_item_normal_state : R.drawable.bg_item_booked_state);
    }
